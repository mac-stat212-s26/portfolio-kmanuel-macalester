...
In alternate situations 1 and, we see that ozone NA values are within a specific subsection of the solar data. In alternate situation 1, some of our solar data is available where ozone is missing, allowing us to compute it. However, in situation 2, we have neither ozone or solar data for some observations, making it harder to analyze. 
